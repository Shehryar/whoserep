...
class FormWithScale: ComponentViewController {
...
extension FormWithScale: ComponentViewControllerDelegate {
...
extension FormWithScale: IdentifiableTestCase {
    static var testCaseIdentifier = "formWithScale"
}
