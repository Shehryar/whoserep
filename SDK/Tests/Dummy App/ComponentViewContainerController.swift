//
//  ComponentViewContainerController.swift
//  Tests
//
//  Created by Hans Hyttinen on 8/8/18.
...
class ComponentViewContainerController: ComponentViewController {
    ...
    func showContainer(fileName: String) {
        let json = TestUtil.dictForFile(named: fileName)
        componentViewContainer = ComponentViewContainer.from(json)
    }
}

extension ComponentViewContainerController: ComponentViewControllerDelegate {
