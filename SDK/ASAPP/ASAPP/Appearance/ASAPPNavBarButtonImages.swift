...
public class ASAPPNavBarButtonImages: NSObject {
    ...
    lazy public var back: ASAPPCustomImage? = {
        return ASAPPCustomImage(image: Images.getImage(.iconArrowLeft)!.tinted(ASAPP.styles.colors.dark, alpha: 0.9), size: CGSize(width: 14, height: 14), insets: UIEdgeInsets(top: 5, left: 0, bottom: 5, right: 0))
    }()
