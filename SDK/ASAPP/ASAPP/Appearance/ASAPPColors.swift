...
public class ASAPPColors: NSObject {
    ...
    public var separatorPrimary: UIColor = UIColor(red: 0.766, green: 0.774, blue: 0.797, alpha: 1)
    ...
    public var messageBorder: UIColor? = UIColor(red: 0.766, green: 0.774, blue: 0.797, alpha: 1)
    ...
    public var quickRepliesBackground: UIColor = UIColor(red: 0.969, green: 0.965, blue: 0.965, alpha: 1)
    
    public var quickRepliesBackgroundPattern: Bool = true
    
    public var quickReplyButton: ASAPPButtonColors = ASAPPButtonColors(
    ...
    public var quickReplyViewButton: ASAPPButtonColors = ASAPPButtonColors(
        backgroundColor: UIColor(red: 0.953, green: 0.957, blue: 0.965, alpha: 1),
        textColor: UIColor(red: 91.0 / 255.0, green: 101.0 / 255.0, blue: 126.0 / 255.0, alpha: 1))
    
    public var chatInput: ASAPPInputColors = ASAPPInputColors(
