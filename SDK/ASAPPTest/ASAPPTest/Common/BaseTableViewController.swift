...
extension BaseTableViewController {
    ...
    func textCell(forIndexPath indexPath: IndexPath,
        ...
        cell.textLabel?.font = AppSettings.shared.branding.fontFamily.bold.changingOnlySize(16)
        cell.textLabel?.textColor = UIColor.darkGray
        
        cell.detailTextLabel?.text = detailText
        cell.detailTextLabel?.font = AppSettings.shared.branding.fontFamily.regular.changingOnlySize(16)
