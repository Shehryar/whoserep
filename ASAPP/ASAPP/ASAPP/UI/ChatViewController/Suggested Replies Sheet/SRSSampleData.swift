...
class SRSSampleData: NSObject {
    ...
    class func sampleResponse() -> SRSItem {
        return R()
    }
    
    class func sampleResponseForContent(content: String) -> SRSItem? {
        switch content {
        case "R": return R()
        case "RI": return RI()
        case "RIC": return RIC()
